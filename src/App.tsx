...
import _5star from './assets/img/5star.png';
    ...
    return (
        <>
            {isLoading ? (
                ...
                <div>
                    <button
                        className="scroll-to-top fixed right-6 bottom-10 lg:bottom-4 z-[22]
        ...
        flex items-center justify-center transition-all p-3"
                    >
                        <ArrowUpIcon width={18} height={18} className="fill-white" />
                    </button>
                    <section ref={home} className="relative h-screen">
                        <div className="background">
                            <header ref={header} className="h-20 flex items-center text-white relative">
                                <nav className="container h-10 flex items-center justify-between">
                                    <a className="font-light text-lg outline-none no-underline" href="/">
                                        Vo Duc Thang
                                    </a>
                                    <ul className="hidden md:flex space-x-8 text-xl font-normal">
                                        <li
                                        ...
                                        <>
                                            <span className="md:hidden" onClick={toggleMenu}>
                                                <MenuIcon
                                                    width={24}
                                                    height={24}
                                                    className="fill-white icon-mobile md:hidden"
                                                />
                                            </span>
                                        </>
                                    )}
                                ...
                                <ul className="menu-mobile absolute w-full top-full px-4 bg-white text-black text-xl font-normal">
                                    <li
                                        className="cursor-pointer hover:text-primary_rgba transition-all"
                                        onClick={() => scrollToSection(home)}
                                    >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                                ...
                                <div className="col-span-1 md:col-span-2">
                                    ...
                                    <div className="text-[#333333] space-y-2">
                                        <p>
                                            Welcome to my personal (React & Vite) website. I hope you can find something
                                            helpful about me!
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            I have acquired the skills and knowledge necessary to make the project a
                                            success.
                                        </p>
                                        <p>I love listening to music and traveling with my family and friends.</p>
                                        <p>
                                            I also LOVE learning new technologies and using them to solve real-life's
                                            problems!
                                        </p>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    ...
                                    <div className="col-span-1">
                                        ...
                                        <div className="text-[#202020] text-sm font-light">
                                            ...
                                            <p>
                                                This is my personal website, a website about selling courses online.
                                                Includes pages such as Homepage, About, Courses, Couse Detail and Blog.
                                            </p>
                                ...
                                <div className="grid grid-cols-1 grid-flow-dense md:grid-cols-2 gap-10">
                                    <div className="col-span-1">
                                        ...
                                        <div className="text-[#202020] text-sm font-light">
                                            <span className="mb-2 inline-block !font-medium">Description</span>
                                            <p>
                                                This is a group project, an e-commerce website about fashion. Clients
                                                can create an account, log in, search, add products to their wishlist,
                                                purchase products and see their order history. Admin can manage
                                                products, categories, users, comments, coupons and orders.
                                            </p>
                                            <span className="my-2 inline-block !font-medium">Technology Used</span>
                                            <ul className="pl-4 space-y-2 list-disc">
                                                <li>HTML5 & CSS3</li>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    ...
                                    <div className="col-span-1">
                                        ...
                                        <div className="text-[#202020] text-sm font-light">
                                            <span className="mb-2 inline-block !font-medium">Description</span>
                                            <p>
                                                This is a group project, an e-commerce website about fashion and
                                                accessories. The client side is built with React, Typescript, Tailwind
                                                and Chakra UI. It allows users to create accounts, log in, and purchase
                                                products,... The server side uses NodeJS, Next.js, Redis, PostgreSQL and
                                                Typescript to provide API when requested by the client side.
                                            </p>
                                            <span className="my-2 inline-block !font-medium">Technology Used</span>
                                            <ul className="pl-4 space-y-2 list-disc">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="col-span-1">
                                        ...
                                        <div className="text-[#202020] text-sm font-light">
                                            <span className="mb-2 inline-block !font-medium">Description</span>
                                            <p>
                                                This is my personal project, a website to show information about me and
                                                some project I had completed
                                            </p>
                                            <span className="my-2 inline-block !font-medium">Technology Used</span>
                                            <ul className="pl-4 space-y-2 list-disc">
                                                <li>React & Vite</li>
                        ...
                        <div className="container py-20">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-0">
                                <div className="col-span-1 text-center md:text-left">
                                    <p>
                                        VoDuc Thang - © Copyright {new Date().getFullYear()}. All rights are reserved.
                                    </p>
                                </div>
